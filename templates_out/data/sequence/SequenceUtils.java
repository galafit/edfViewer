...
public class SequenceUtils {
     ...
     * it is not sorted, the results are undefined. If the minMax containsInt
     ...
     *         or <tt>fromIndex + intervalLength - 1</tt> if all
     ...
     *     then (<b>fromIndex + intervalLength</b>) will be returned</li>
     * </ul>
     * Behaviour for unsorted arrays is unspecified.
     * <p>
     * Complexity O(log n).
   ...
   public static long getValueBits(String value, String valueType) {
    ...
    public static void main(String args[]) {
        ...
        System.out.println(a[a.length - 1] + "]   rowCount = "+a.length);
        ...
        System.out.println(b[b.length - 1] + "]   rowCount = "+b.length);
