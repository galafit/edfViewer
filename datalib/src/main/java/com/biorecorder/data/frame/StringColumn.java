...
class StringColumn {
    ...
    protected final StringSequence series;

    public StringColumn(StringSequence series) {
        this.series = series;
    }
    ...
    public StringColumn subColumn(long fromIndex, long length) {
        StringSequence subSeries = new StringSequence() {
            @Override
            public long size() {
                return length;
            }
    ...
    public StringColumn cache() {
        ...
        return new StringColumn(new StringSequence() {
            @Override
            public long size() {
