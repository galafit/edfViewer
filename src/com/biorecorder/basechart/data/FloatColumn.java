...
class FloatColumn extends NumberColumn {
    ...
    class GroupingManager {
        ...
        private final FloatGroupFunction groupingFunction;
        ...
        public GroupingManager(GroupApproximation groupingApproximation, LongSeries groupStartIndexes) {
            ...
            groupingFunction = (FloatGroupFunction) groupingApproximation.getGroupingFunction("float");
        ...
        private float[] getGroupValues(long groupIndex) {
            ...
            float[] groupedValues = groupingFunction.addToGroup(series, groupStartIndexes.get(groupIndex) + lastGroupValueLength, groupEnd - groupStartIndexes.get(groupIndex) - lastGroupValueLength);
        ...
        public NumberColumn[] groupedColumns() {
            ...
            for (int i = 0; i < resultantColumns.length; i++) {
                ...
                FloatSeries groupedSeries = new FloatSeries() {
                    @Override
                    public long size() {
                        return groupsCount();
                    }
                ...
                resultantColumns[i] = new FloatColumn(groupedSeries);
