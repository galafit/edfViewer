...
public class DoubleRegularSeries implements DoubleSeries {
    protected double dataInterval;
    protected double startValue;
    protected long size = Long.MAX_VALUE;

    public DoubleRegularSeries(double startValue, double dataInterval, long size) {
        this.dataInterval = dataInterval;
        this.startValue = startValue;
        this.size = size;
    }

    public DoubleRegularSeries(double startValue, double dataInterval) {
