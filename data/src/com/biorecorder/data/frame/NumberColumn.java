...
public abstract class NumberColumn {
    ...
    protected AggregateFunction[] aggregateFunctions = {AggregateFunction.AVERAGE};
     ...
     *
     * @param aggregateFunctions approximations used when data are grouped
     */
    ...
    public abstract NumberColumn[] group(LongSequence groupIndexes);
