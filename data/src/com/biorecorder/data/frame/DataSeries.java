...
import com.biorecorder.basecharts.SubRange;
...
public class DataSeries  {
    ...
    private void setXData(NumberColumn column) {
        xColumn = column;
        xColumn.setAggregateFunctions(AggregateFunction.OPEN);
        updateSize();
    }
    ...
    public void setXData(IntSequence series) {
  ...
  /*  public void setXData(FloatSeries series) {
    ...
    public void addYData(IntSequence series) {
  ...
  /*  public void addYData(FloatSeries series) {
    ...
    public void setAnnotations(StringSequence series) {
    ...
    public DataSeries group(LongSequence groupStartIndexes) {
