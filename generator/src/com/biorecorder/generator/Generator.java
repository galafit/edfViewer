 ...
 * ///////////////////////////////////////////////////////////////////////////////
 *
 * Forked from Trove collections:
 * https://bitbucket.org/trove4j/trove/src/24dd57f48bf385fa41a878f8fad7ac44d8b1d53a/generator/src/main/java/gnu/trove/generator/Generator.java?at=master&fileviewer=file-view-default
 */

package com.biorecorder.generator;
import java.io.*;
 ...
 * replacing patterns in the template files (file extention: tmpl).</p>
 * <p> Get from Trove: https://bitbucket.org/trove4j/trove/src/3237c62b59245913a554ce1ed27c768aad7ac6ac/generator/src/main/java/gnu/trove/generator/?at=master</p>
 * <p><b>Patterns</b></p>
 * <p>
...
public class Generator {
    ...
    private static final String FILE_EXTENTION = "tmpl";
    ...
    public static void main(String[] args) throws Exception {
        ...
        File input_directory = new File(projectDir, args[arg_index++]);
        File output_directory = new File(projectDir, args[arg_index++]);
    ...
    private static void processFile(File input_file, File output_directory)
        ...
        file_name = file_name.replaceAll("\\."+ FILE_EXTENTION, ".java");
